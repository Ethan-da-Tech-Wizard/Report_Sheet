...
TEMPLATES_DIR = '/Users/mirandazavala/Desktop/Report_Sheet/templates'
...
<table>
  <tr>
    ...
    <th width="10%">Bowel & Bladder</th>
    <th width="18%">VITALS (BP / HR / T / O2 / RR)</th>
    <th width="14%">Q2H Turn & BM Log</th>
    <th width="11%">Safety & Notes</th>
  </tr>
  """ + "".join([f"<tr><td><b>Rm:</b> ____<br/><b>Name:</b><br/>__________</td><td align='center'>FULL /<br/>DNR<br/>DNI /<br/>POLST</td><td><b>DIET:</b> REG / MECH /<br/>MOIST / PUREE / NPO<br/><b>LIQ:</b> THIN / NECT /<br/>HONY / PUDD /<br/>RESTR</td><td><b>ADL:</b> IND / SUP / LIM /<br/>EXT / TOT<br/><b>EQUIP:</b> 1PA / 2PA |<br/>FWW / HYR / SARA /<br/>WC</td><td><b>BOWEL:</b> CONT / INC<br/><b>BLADD:</b> CONT / INC<br/>FOLEY / OSTOMY</td><td><b>BP:</b> ________________________<br/><b>HR:</b> _________  <b>T:</b> _________<br/><b>O2:</b> _______% ( <span class='chk'></span><b>RA</b> <span class='chk'></span><b>NC</b> )<br/><b>RR:</b> _________</td><td><b>TURNS:</b> <span class='chk'></span>8 <span class='chk'></span>10 <span class='chk'></span>12 <span class='chk'></span>2<br/><span class='chk'></span>4 <span class='chk'></span>6<br/><b>BM:</b> <span class='chk'></span>0 <span class='chk'></span>S <span class='chk'></span>M <span class='chk'></span>L<br/><b>ADL:</b> <span class='chk'></span>Shower <span class='chk'></span>Bath <span class='chk'></span>Skin <span class='chk'></span>Oral</td><td><span class='chk'></span>Fall <span class='chk'></span>LoBd <span class='chk'></span>Iso<br/><b>Notes:</b></td></tr>" for _ in range(14)]) + """
</table>
"""
